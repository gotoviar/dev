...
function _emscripten_async_wget2_data(url, request, param, arg, free, onload, onerror, onprogress) {
 ...
 function onerrorjs() {
  if (onerror) {
   ...
   (function(a1, a2, a3, a4) {
    dynCall_viiii.apply(null, [ onerror, a1, a2, a3, a4 ]);
   })(handle, arg, http.status, statusText);
  }
 }
 http.onload = function http_onload(e) {
  if (http.status >= 200 && http.status < 300 || http.status === 0 && _url.substr(0, 4).toLowerCase() != "http") {
   ...
   if (onload) (function(a1, a2, a3, a4) {
    dynCall_viiii.apply(null, [ onload, a1, a2, a3, a4 ]);
   })(handle, arg, buffer, byteArray.length);
 ...
 http.onprogress = function http_onprogress(e) {
  if (onprogress) (function(a1, a2, a3, a4) {
   dynCall_viiii.apply(null, [ onprogress, a1, a2, a3, a4 ]);
  })(handle, arg, e.loaded, e.lengthComputable || e.lengthComputable === undefined ? e.total : 0);
 };
